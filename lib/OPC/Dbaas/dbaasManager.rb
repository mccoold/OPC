...
#
class DbaasManager < Dbaas
  def scale_up(data, domain_id, user, passwd, inst_id)
    uri = URI.parse("https://dbaas.oraclecloud.com/paas/service/dbcs/api/v1.1/instances/#{domain_id}/#{inst_id}")
  ...
  def power(inst_id, action, id_domain, user, passwd)
    config = {
